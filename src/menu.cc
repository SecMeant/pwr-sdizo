...
int main()
{
  ...
  edge_heap_max.insert({7,3});
  edge_heap_max.insert({9,11});
  edge_heap_max.insert({12,90});
  edge_heap_max.display();
  assert(edge_heap_max.verify());
  edge_heap_max.remove({12,90});
  assert(edge_heap_max.verify());
  edge_heap_max.insert({1,2});
  edge_heap_max.insert({4,5});
  edge_heap_max.insert({7,3});
  ...
  edge_heap_min.insert({7,3});
  edge_heap_min.insert({9,11});
  edge_heap_min.insert({12,90});
  edge_heap_min.display();
  assert(edge_heap_min.verify());
  edge_heap_min.remove({12,90});
  assert(edge_heap_min.verify());
  edge_heap_min.insert({1,2});
  edge_heap_min.insert({4,5});
  edge_heap_min.insert({7,3});
